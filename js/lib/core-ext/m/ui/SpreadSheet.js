...
{
  return SpreadSheet.Class.construct(this, arguments);
}

Class(SpreadSheet)
.inherit(ElementConfInputStore)
.property("conf", {locale: "en", startOpen: false, stayOpen: false, closeButton: false, timeFormat: false, dateFormat: "YYYY-mm-dd"})
...
SpreadSheet.prototype.construct = function()
{
  this.rebuild();
};
...
SpreadSheet.prototype.rebuild = function()
{
  this.html("");
  ...
  this.spreadsheet = jexcel(this.sheet, this.conf());
};

//------------------------------------------------------------------------------

function mSpreadSheet()
{
