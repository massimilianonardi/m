...
function Tree()
{
  return Tree.Class.construct(this, arguments);
}
...
Tree.prototype.rebuild = function()
{
  ...
  this.node.appendChild(this._tree);
  
  var conf = this.conf() || {};
  if(!conf.schema) conf.schema = {};
  var root = new TreeNode("root", this._tree);
  this.tree = new TreeView(root);
  this.tree.setContainer(this._tree);
...
//	default_close_icon: "<span>&#9654;</span>",
	default_leaf_icon: "<i class='icon icon-tree-leaf'></i>",
	default_parent_icon: "<i class='icon icon-tree-parent'></i>",
	default_open_icon: "<i class='icon icon-tree-node-open'></i>",
	default_close_icon: "<i class='icon icon-tree-node-closed'></i>",
