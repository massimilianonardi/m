...
{
  replaceModulesDynamically(path, jsModulesFile, jsElement, "modules-js.json", "script");
}
...
{
  replaceModulesDynamically(path, cssModulesFile, cssElement, "modules-css.json", "style");
}
