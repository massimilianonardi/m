...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/${PLATFORM}/RemoteLoader_srv.dlib

dist/Debug/${PLATFORM}/RemoteLoader_srv.dlib: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/${PLATFORM}
	${LINK.cc} -shared -o dist/Debug/${PLATFORM}/RemoteLoader_srv.dlib -fPIC ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf:
	${RM} -r build/Debug
	${RM} dist/Debug/${PLATFORM}/RemoteLoader_srv.dlib
