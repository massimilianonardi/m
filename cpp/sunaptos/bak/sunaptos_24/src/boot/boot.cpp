...
Sequence Boot::f(number i, Sequence& params)
{
  ...
  try_managed
  Service* srv = 0;
  srv = k->f(Kernel::create, params = "simple");
  srv->f(1, params = "simple local");

  srv = k->f(Kernel::create_separate, params = "simple");
  srv->f(2, params = "simple remote");
  
  srv = k->f(Kernel::create_separate, params = "gui");
...
//  i2->f(1, params = "i2");
  ...
  k->f(Kernel::exit_process, params = "");
//  o << (long) srv; throw o;
