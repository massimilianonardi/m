...
${OBJECTDIR}/streaminput.o: streaminput.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/streaminput.o streaminput.cpp
...
${OBJECTDIR}/streamoutput.o: streamoutput.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/streamoutput.o streamoutput.cpp

${OBJECTDIR}/streamable.o: streamable.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2  -MMD -MP -MF $@.d -o ${OBJECTDIR}/streamable.o streamable.cpp
