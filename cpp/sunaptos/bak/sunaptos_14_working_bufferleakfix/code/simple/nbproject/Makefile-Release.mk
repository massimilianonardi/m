...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/MinGW-Windows/simple.

dist/Release/MinGW-Windows/simple.: ../core/dist/Release/MinGW-Windows/core.dll

dist/Release/MinGW-Windows/simple.: ${OBJECTFILES}
...
${OBJECTDIR}/simple.o: simple.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../core  -MMD -MP -MF $@.d -o ${OBJECTDIR}/simple.o simple.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/MinGW-Windows/simple.
