...
//  virtual SequenceNode& operator=(const SequenceNode& e){return link(e);}
  ...
  SequenceNode(const std::shared_ptr<Service>& e){*this = e;}
  operator std::shared_ptr<Service>() const {return srv;}
  SequenceNode& operator=(const std::shared_ptr<Service>& e){srv = e; *elements = (void*) e.get(); return *this;}
