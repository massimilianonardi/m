...
java -jar regreplace.jar "iface_template/dlib.cpp" "dist/%1/dlib.cpp.tmp" "template_class" "%1" false
java -jar regreplace.jar "iface_template/template.h" "dist/%1/%2.h.tmp" "template_class" "%1" false
