...
SequenceNode SequenceNode::op() const
{
  ...
  {
    Service* srv = (*this)(0);
    if(srv == 0) // todo ask loader if srv pointer is invalid (that is this sequence was streamed)
    {
      srv = load((*this)(1), (*this)(2)).get();
      SequenceNode s = &(*this)(0);
      s = srv;
    }
    return srv->f((*this)(3), (*this)(4));
  }
  else
  {
    exception_throw_type(ExceptionType::invalid_operand)
