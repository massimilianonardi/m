...
// BASIC DATA TYPES CAST (get, set) --------------------------------------------
  ...
  SequenceNode& type_set(StandardDataTypes standard_data_type){*this = (double) standard_data_type; (*this)[size()] = 2; return *this;}
...
public:
  ...
  SequenceNode& operator=(const Service* srv){*this = (const void*) srv; return *this;}
