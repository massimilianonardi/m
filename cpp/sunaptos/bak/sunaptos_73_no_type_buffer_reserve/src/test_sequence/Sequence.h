...
//  operator void*(){return (void*) *(double*) cast_pointer_get();}
...
//  operator void*() const {return (void*) *(double*) cast_pointer_get();}
  
  SequenceNode& operator=(double basic_data_type_element){*this = std::move(SequenceNode()); buffer->reserve(sizeof(double)); *((double*) cast_pointer_get()) = basic_data_type_element; return *this;}
...
//  SequenceNode& operator=(const void* basic_data_type_element){*this = (double) basic_data_type_element; return *this;}
  
  bool is_number() const {return ((size() == 0) && (buffer->reserved() == sizeof(double)));}
