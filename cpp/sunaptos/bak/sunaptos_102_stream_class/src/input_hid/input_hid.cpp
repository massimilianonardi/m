...
SERVICE_METHOD_DEFINITION(input_hid, subscribe)
{
...
SERVICE_METHOD_DEFINITION(input_hid, insert)
{
}

SERVICE_METHOD_DEFINITION(input_hid, remove)
{
}

SERVICE_METHOD_DEFINITION(input_hid, read)
{
}
