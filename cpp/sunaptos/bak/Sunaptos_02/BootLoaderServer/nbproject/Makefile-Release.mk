...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/${PLATFORM}/libBootLoaderServer.dll

dist/Release/${PLATFORM}/libBootLoaderServer.dll: ${OBJECTFILES}
	${MKDIR} -p dist/Release/${PLATFORM}
	${LINK.cc} -shared -o dist/Release/${PLATFORM}/libBootLoaderServer.dll -fPIC ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/${PLATFORM}/libBootLoaderServer.dll
