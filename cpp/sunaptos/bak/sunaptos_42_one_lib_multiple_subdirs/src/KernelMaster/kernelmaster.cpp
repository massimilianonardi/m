...
//Sequence KernelMaster::f(const Sequence& i, const Sequence& params)
//{
////  debug("[KernelMaster::f 00] i = " << (long) i << " - params = " << (char*) params)
//  Sequence res;
//
//  switch((long)(Sequence) i)
//  {
...
SERVICE_METHOD_DISPATCHER(KernelMaster)
  SERVICE_REGISTER_METHOD_BY_ID(Kernel::create_separate, createSeparate)
  SERVICE_REGISTER_METHOD_BY_ID(Kernel::create_remote, createRemote)
  SERVICE_REGISTER_METHOD_BY_ID(Kernel::notify_startup, notifyStartup)
  SERVICE_REGISTER_METHOD_BY_NAME(createSeparate)
  SERVICE_REGISTER_METHOD_BY_NAME(createRemote)
  SERVICE_REGISTER_METHOD_BY_NAME(notifyStartup)
SERVICE_METHOD_DISPATCHER_END

Sequence KernelMaster::createSeparate(const Sequence& params)
{
...
Sequence KernelMaster::notifyStartup(const Sequence& params)
{
