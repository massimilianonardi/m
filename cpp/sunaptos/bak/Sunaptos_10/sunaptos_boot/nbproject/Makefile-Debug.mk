...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/MinGW-Windows/boot.

dist/Debug/MinGW-Windows/boot.: ../sunaptos_core_library/dist/Debug/MinGW-Windows/libsunaptos_core_library.dll

dist/Debug/MinGW-Windows/boot.: ../sunaptos_core_library/dist/Release/MinGW-Windows/libsunaptos_core_library.dll

dist/Debug/MinGW-Windows/boot.: ${OBJECTFILES}
...
${OBJECTDIR}/dlib.o: dlib.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../sunaptos_core_library  -MMD -MP -MF $@.d -o ${OBJECTDIR}/dlib.o dlib.cpp

${OBJECTDIR}/boot.o: boot.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../sunaptos_core_library  -MMD -MP -MF $@.d -o ${OBJECTDIR}/boot.o boot.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/MinGW-Windows/boot.
