...
//  return Class(Map).construct(this, undefined, properties);
  return Class(Map2).construct(this, properties);
}

Class(Map2)
.inherit(ui.core.ElementControl)
.property("servers")
.property("sources")
...
//      ps.parser = new ol.format.GeoJSON();
//      ps.format = new ol.format.WFS();
    }
    pl.source = new fs(ps);
//    pl.style = new ol.style.Style({
...
//        });
//    pl.visible = true;
//    pl.updateWhileAnimating = true;
//    pl.updateWhileInteracting = true;
//    pl.style = new ol.style.Style(
//    {
...
Map2.prototype.changed = function(data)
{
  this.update();
};
...
Map2.prototype.saved = function(data)
{
};

//------------------------------------------------------------------------------

Map2.prototype.errorLoad = function(response)
{
};

//------------------------------------------------------------------------------

Map2.prototype.errorSave = function(response)
{
};
