...
function DateRange()
{
  return DateRange.Class.construct(this, arguments);
}

Class(DateRange)
.inherit(ElementConfInputStore)
//.property("conf", {locale: "en", startOpen: false, stayOpen: false, closeButton: false, timeFormat: false, dateFormat: "YYYY-mm-dd", mPlaceholderYear: "Year", mPlaceholderMonth: "Month", mPlaceholderDay: "Day"})
...
DateRange.prototype.construct = function()
{
  this.rebuild();
};
...
DateRange.prototype.update = function()
{
  this.rebuild();
};
...
DateRange.prototype.rebuild = function()
{
  this.html("");
  ...
  var _this = this;
  var conf = this.conf();
  conf.container = this.node;
//  conf.onSelect = function(date){conf.defaultDate = _this.date.selectedDate.toISOString().split("T")[0];};
  this.date = new Datepickk(conf);
  this.date.show();
