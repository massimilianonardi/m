...
public class FileSystemAuthenticationSandbox extends ConfigurableWrapper<___FileSystem> implements Z_AuthorizedService, Z_Authorizator.Listener
{
  ...
  public class FileAlias
  {
    ...
    public FileAlias(Z_AuthorizationSession session, String alias) throws Exception
    {
      int index;
