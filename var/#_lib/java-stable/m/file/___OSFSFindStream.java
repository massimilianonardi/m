...
public class ___OSFSFindStream implements StreamInput
{
  protected Path path;
  ...
  public ___OSFSFindStream(String listPath) throws Exception
  {
...
//      ds.close();
  ...
  public ___OSFSFindStream(String findPath, Map options) throws Exception
  {
