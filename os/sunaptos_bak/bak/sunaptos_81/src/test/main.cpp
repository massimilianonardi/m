...
//  debug((char*) b2)
  ...
  s1.links_ins("H");
  debug(s1.to_string())
  (s1 = "first").links_ins(((empty_sequence = "second").links_ins("third")));
  s1.links_ins("fourth");
  debug(s1.to_string())
  debug(s1(0).to_string())
  debug(s1(0)(0).to_string())
//  Sequence i = empty_sequence.links_ins(0);
  Sequence i = empty_sequence;
  debug_line
  i = i.links_ins(0);
  debug(i.to_string())
...
//  s1 << ((seq) "s0" << ((seq) "s1" << ((seq) "s2" << (seq) "s3")));
  s1.links_ins((seq("s0").links_ins((seq("s1").links_ins((seq("s2").links_ins("s3")))))));
  debug(s1.to_string())
  i = (seq().links_ins(2).links_ins(0));
  debug(i.to_string())
  debug(s1.links_get(i).to_string())
  debug(s1.links_get(seq().links_ins(2).links_ins(0)).to_string())
  s1 = "test";
  s1.links_ins((seq("s0").links_ins((seq("s1").links_ins((seq("s2").links_ins("s3")))))));
  debug(s1.to_string())
  s1 = "test";
