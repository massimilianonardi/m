...
SequenceNode SequenceNode::op() const
{
  if(!is_type_standard())
  {
  ...
  {
//    Service* srv = load((*this)(0), (*this)(1)).get();
//    SequenceNode method = (*this)(2);
//    SequenceNode params = (*this)(3);
//    SequenceNode result = (*srv)(method, params);
//    return result;
//    return load((*this)(0), (*this)(1))->f((*this)(2), (*this)(3));
  }
  else
  {
    exception_throw_type(ExceptionType::invalid_operand)
