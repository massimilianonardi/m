...
${CND_OUTPUTPATH}/${CND_OUTPUTFILENAME}: ${OBJECTFILES}
	...
	${LINK.cc} `pkg-config --libs gtk+-2.0` -shared -o ${CND_OUTPUTPATH}/${CND_OUTPUTFILENAME} -fPIC  ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/dlib.o: dlib.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG -I${CND_CPPINCLUDES} -I../core -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/dlib.o dlib.cpp

${OBJECTDIR}/gui.o: gui.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG -I${CND_CPPINCLUDES} -I../core -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/gui.o gui.cpp
