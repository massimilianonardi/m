...
//  debug((char*) b2)
  ...
  s1 << "H";
  debug(s1.to_string())
  (s1 = "first") << ((empty_sequence = "second") << "third");
  s1 << "fourth";
  debug(s1.to_string())
...
//  s1.links_ins("s0",0)(0).links_ins("s1",0)(0).links_ins("s2",0)(0).links_ins("s3",0);
//  s1 << ("s0" << ("s1" << ("s2" << "s3")));
//  s1 << ("s0" << ("s1" << ("s2" << Sequence("s3"))));
//  s1 << (empty_sequence = "s0" << (empty_sequence = "s1" << (empty_sequence = "s2" << empty_sequence = "s3")));
//  ((s1 << "s0")(0) << "s1")(0) << "s2";
//  (s1 << "s0" &=-1) << "s1" &=-1 << "s2";
//  s1 << "s0", "s1", "s2", "s3";
  debug(s1.to_string())
  ...
  debug(i.to_string())
  debug(s1.links_get(i).to_string())
  debug(s1.links_get(seq() << 2 << 0).to_string())
  s1 = "test";
  s1 << ((seq) "s0" << ((seq) "s1" << ((seq) "s2" << (seq) "s3")));
  debug(s1.to_string())
  s1 = "test";
//  s1 << "s0", "s1", "s2", "s3";
  ...
  s1.op(1 << 2 << 3);
//  s1 ^ empty_sequence = 1 << 2 << 3;
//  s1 seqop 1 << 2 << 3;
//  s1 ^ "$:s:<>:[$:s:<test>;]:[$:s:<-append>;]:[$:n:<72>;]:[$:n:<7>;]:[$:s:<H>;];";
//  s1 seqop "$:s:<>:[$:s:<test>;]:[$:s:<-append>;]:[$:n:<72>;]:[$:n:<7>;]:[$:s:<H>;];";
}
