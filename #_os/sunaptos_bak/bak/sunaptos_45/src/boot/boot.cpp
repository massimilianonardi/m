...
//  Sequence seqsrv = load("simple", 0);
//  ServiceSequence seqsrv = load("simple", 0);
  ServiceLoader srvl("simple", 0);
//  ServiceLoader srvl2 = srvl;
  debug_line
  Service& srv = *srvl;
//  delete &srv;
  debug("[Boot::f 02]")
...
//  Service& krn = ldr::i().create("LoaderAdvanced", params);
//  Service& krn = load("LoaderAdvanced", params);
//  srv = krn.create("simple");
//  ServiceLoader krnl("LoaderAdvanced", params);
//  srv = (*krnl).create("simple");
  ServiceLoader krnl(".simple", params);
  debug_line
  srv = *krnl;
  srv.create("testing simple create...");
  srv.destroy("testing simple destroy...");
