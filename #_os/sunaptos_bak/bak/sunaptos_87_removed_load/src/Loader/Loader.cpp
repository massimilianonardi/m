...
{
  debug((long long)(Service*) params)
  debug((long long)(Service*) ldr_map[params])
...
{
  if(params != Sequence()) return ldr->stop(params);
  lck.unlock();
  return SERVICE_NULL;
}
