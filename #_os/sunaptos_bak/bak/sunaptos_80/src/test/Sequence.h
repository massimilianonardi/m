...
public:
  ...
  SequenceNode& links_ins(const SequenceNode& sequence_node){sequence_links->insert(sequence_links->end() - 1, sequence_node); return *this;}
  SequenceNode& links_ins(SequenceNode&& sequence_node){sequence_links->insert(sequence_links->end() - 1, std::move(sequence_node)); return *this;}
  SequenceNode& links_ins(SequenceNode* sequence_node){sequence_links->insert(sequence_links->end() - 1, std::move((*sequence_node).link())); return *this;}
