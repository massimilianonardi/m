...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/${PLATFORM}/libRemoteLoader_cli.dll

dist/Release/${PLATFORM}/libRemoteLoader_cli.dll: ${OBJECTFILES}
	${MKDIR} -p dist/Release/${PLATFORM}
	${LINK.cc} -shared -o dist/Release/${PLATFORM}/libRemoteLoader_cli.dll -fPIC ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/${PLATFORM}/libRemoteLoader_cli.dll
