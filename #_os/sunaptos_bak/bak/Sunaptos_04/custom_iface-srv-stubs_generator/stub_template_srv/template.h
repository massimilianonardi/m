#ifndef _template_define_SRV_H
#define	_template_define_SRV_H
...
class template_class_srv: virtual public CommandListener
{
  private:
    template_class* srv;
    
  public:
    template_class_srv(template_class* srv);
    virtual ~template_class_srv();
    
    Data* processCommand(int cmd, Data* msg);
};

#endif	// _template_define_SRV_H
