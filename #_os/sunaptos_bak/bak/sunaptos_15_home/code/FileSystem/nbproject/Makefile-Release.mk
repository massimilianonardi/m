...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/MinGW-Windows/FileSystem.

dist/Release/MinGW-Windows/FileSystem.: ../core/dist/Release/MinGW-Windows/core.dll

dist/Release/MinGW-Windows/FileSystem.: ${OBJECTFILES}
...
${OBJECTDIR}/filesystem.o: filesystem.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I../core  -MMD -MP -MF $@.d -o ${OBJECTDIR}/filesystem.o filesystem.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/MinGW-Windows/FileSystem.
