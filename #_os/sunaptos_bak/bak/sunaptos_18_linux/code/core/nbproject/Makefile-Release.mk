...
${OBJECTDIR}/_ext/430067393/fileinputstream.o: /host/data/dev/sa/sunaptos/sunaptos_current/code/core/fileinputstream.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -I${CND_CPPINCLUDES} -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/430067393/fileinputstream.o /host/data/dev/sa/sunaptos/sunaptos_current/code/core/fileinputstream.cpp
...
${OBJECTDIR}/_ext/430067393/fileoutputstream.o: /host/data/dev/sa/sunaptos/sunaptos_current/code/core/fileoutputstream.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/430067393
	${RM} $@.d
	$(COMPILE.cc) -O2 -I${CND_CPPINCLUDES} -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/430067393/fileoutputstream.o /host/data/dev/sa/sunaptos/sunaptos_current/code/core/fileoutputstream.cpp
