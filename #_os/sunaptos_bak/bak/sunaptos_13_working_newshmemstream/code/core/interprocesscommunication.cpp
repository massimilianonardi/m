...
InterProcessCommunication::InterProcessCommunication(): SharedMemoryStream(0)
{
}
...
{
  // todo: rewrite all ipc system supporting very long call/results by splitting reads/writes by size of shared memory
//  cmdposted = pdata;
...
//  std::cout << "\n[InterProcessCommunication::readparams] params = " << (char*) params;
...
//  std::cout << "\n[InterProcessCommunication::readres] res = " << (char*) res;
