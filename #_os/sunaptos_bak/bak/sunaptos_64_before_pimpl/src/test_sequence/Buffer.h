...
public:
  ...
  char& operator[](long index) const {return ((char*) get())[index];}
...
//  BufferBasicDataTypes& operator=(const wchar_t* e){t = BasicDataTypes::type_wchar_t_pointer; set(e, (wcslen(e) + 1) * sizeof(wchar_t)); return *this;}
  ...
  BufferBasicDataTypes& operator=(char* e){t = BasicDataTypes::type_char_pointer; set(e, strlen(e)); return *this;}
  BufferBasicDataTypes& operator=(wchar_t* e){t = BasicDataTypes::type_wchar_t_pointer; set(e, wcslen(e) * sizeof(wchar_t)); return *this;}

  BufferBasicDataTypes& operator=(const char* e){t = BasicDataTypes::type_char_pointer; set(e, strlen(e)); return *this;}
  BufferBasicDataTypes& operator=(const wchar_t* e){t = BasicDataTypes::type_wchar_t_pointer; set(e, wcslen(e) * sizeof(wchar_t)); return *this;}
