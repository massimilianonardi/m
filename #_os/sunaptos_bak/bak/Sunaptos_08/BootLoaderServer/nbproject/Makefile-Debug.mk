...
${OBJECTDIR}/dlib.o: dlib.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../core -I../BootLoader -I../Storage -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/dlib.o dlib.cpp

${OBJECTDIR}/BootLoaderServer.o: BootLoaderServer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I../core -I../BootLoader -I../Storage -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/BootLoaderServer.o BootLoaderServer.cpp
