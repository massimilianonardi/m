...
//    virtual sequence& intervention(sequence& params) = 0;
    ...
    virtual sequence& f(sequence& i, sequence& params, sequence& res); // can be reimplemented for performance-critical services
    virtual sequence f(sequence i, sequence params);
