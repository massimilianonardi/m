...
public class WebObjInput extends ObjInputStream
{
  ...
  static protected Gson gson = new GsonBuilder().serializeNulls().create();
...
//      System.out.println("PART content-disposition: " + part.getHeader("content-disposition"));
      m.Global.log.trace("PART type: " + type, "PART name: " + name, "PART size: " + size, "PART sub filename: " + fileName, "PART header names: " + part.getHeaderNames().toString(), "PART content-disposition: " + part.getHeader("content-disposition"));
