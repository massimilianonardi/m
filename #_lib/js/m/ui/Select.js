...
.getter("value", function(value)
{
  ...
  else if(typeof this.select.options !== "undefined")
  {
    var v = [];
...
//      if(o.selected === true)
      if(typeof o.attributes.selected !== "undefined" && o.attributes.selected.value === "selected")
      {
        v.push(o.value);
      }
    }
...
.setter("value", function(value)
{
  ...
  if(this.conf().multiple !== true || !Array.isArray(value))
  {
    this.selectr.options.select(value, "#");
  }
  else
  {
    this.selectr.options.all("unselect", "#");
    for(var i = 0; i < value.length; i++)
    {
      this.selectr.options.select(value[i], "#");
    }
  }
...
Select.prototype.rebuild = function()
{
  ...
  {
    if(_this.select_lock) return;
    if(typeof _this.value.listener === "function")
    {
      _this.value.listener.call(_this, _this.value(), _this._property_value);
    }
    _this._property_value = _this.value();
  });
