...
public class Z_BaseAuthorizationSession implements Z_AuthorizationSession
{
  protected String id;
  
  protected Z_Authorizator authorizator;
  protected Profiler profiler;
  
  protected List<Listener> listeners = new ArrayList();
  protected Map<String, String> attributes = new HashMap<String, String>();
  
  public Z_BaseAuthorizationSession(Z_Authorizator authorizator, Profiler profiler, String sessionID) throws Exception
  {
    if(sessionID == null)
    {
      throw new Exception();
...
//    }
  ...
  public boolean execute(String command, ObjInput in, ObjOutput out) throws Exception
  {
    ...
    Z_AuthorizedService service = authorizator.services().prefix(command);
