...
{
  return JSONFormEditor.Class.construct(this, arguments);
}
...
JSONFormEditor.prototype.construct = function()
{
  this.rebuild();
};
...
JSONFormEditor.prototype.update = function()
{
//  this.rebuild();
};
...
JSONFormEditor.prototype.rebuild = function()
{
  this.html("");
